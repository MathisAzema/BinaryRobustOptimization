...
# Default to SCIP to avoid requiring optional solvers at load time
SOLVER = "SCIP"
# SOLVER = "Gurobi"
"""
    set_solver_SCIP()
...
export SubproblemType, LinearizedKKT, IndicatorKKT, LinearizedDual, IndicatorDual, CCGM, CCGL, CCGLDC, Enumeration
